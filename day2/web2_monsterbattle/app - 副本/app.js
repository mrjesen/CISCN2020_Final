...
function getPlayerAggressivity() //生成攻击力
{
    ...
    if (req.body && typeof req.body== 'object' )
    {
        ...
        for ( let i in tempPlayer )
        {
            if (player[i]) {
                ...
                player["career"] = tempPlayer["career"]
                player["item"] = tempPlayer["item"]
                player["round_to_use"] = tempPlayer["round_to_use"]
            }
        }
