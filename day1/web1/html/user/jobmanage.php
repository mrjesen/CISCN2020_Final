...
$bigclass=isset($_GET["bigclass"])?$_GET["bigclass"]:'';
?>
<div class="content">
<div class="admintitle">
<span>
 <form name="form1" method="post" action="?">
职位：<input name="cpmc" type="text" id="cpmc"> <input name="Submit" type="submit" value="查找">
 </form>
</span>招聘信息管理</div>
<?php
	...
	if ($row["passed"]==1 ){ echo "已审";}else{ echo "<font color=red>待审</font>";}
	  ...
	  ?> </td>
            <td align="center" class="docolor"> 
              <a href="job.php?do=modify&id=<?php echo $row["id"]?>&page=<?php echo $page?>">修改</a></td>
