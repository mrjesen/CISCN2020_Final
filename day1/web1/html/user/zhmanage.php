...
<span><form name="form1" method="post" action="?">标题：<input name="keyword" type="text" id="keyword"> <input type="submit" name="Submit" value="查找"></form></span>展会信息管理</div>
<?php
...
<form name="myform" method="post" action="del.php" onSubmit="return anyCheck(this.form)">
        <table width="100%" border="0" cellpadding="5" cellspacing="1" class="bgcolor">
          <tr class="trtitle"> 
          <td width="40%" class="border">标题</td>
...
?>
	...
	if ($row["passed"]==1 ){ echo '已审核';}else{ echo '<font color=red>待审</font>';}
	  ?>            </td>
            <td align="center" > 
              <a href="zh.php?do=modify&id=<?php echo $row["id"]?>&page=<?php echo $page?>">修改</a></td>
