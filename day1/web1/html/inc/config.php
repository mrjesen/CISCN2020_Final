<?php
define('sqldb','xxcms');//数据库名
define('sqluser','r00t');//用户名
define('sqlpwd','This_cant_b3_passwd');//密码
define('sqlhost','127.0.0.1');//连接服务器,本机填localhost，外地填IP地址
define('sqlport','3306');//端口（默认为:3306）
define('zzcmsver','Powered By <a target=_blank style="font-weight:bold;letter-spacing:1px;text-shadow:-1px 0 #FFF,0 1px #FFF,1px 0 #FFF,0 -1px #FFF;" href=http://www.zzcms.net><font color=#FF6600 face=Arial>ZZ</font><font color=#025BAD face=Arial>CMS201910</font></a>');//版本
define('sitename','zzcms产品招商模板演示站') ;//网站名称
define('siteurl','') ;//网站地址
...
define('whendlsave','Yes') ;//当有代理或求购留言是否打开在线发邮件功能
...
define('sender','') ;//发送邮件的地址
define('smtppwd','') ;//email密码
define('sendsms','Yes') ;//发手机短信开关
define('smsusername','') ;//SMS用户名
define('smsuserpass','') ;//SMS密码
define('apikey_mobile_msg','') ;//apikey_mobile_msg
...
define('shuxing_name','包装规格|零售价格') ;//产品更多属性设置
...
define('siteskin_mobile','mobile1') ;//网站手机端模板
define('ztskin','tongyong') ;//展厅电脑端默认模板
define('ztskin_mobile','mobile2') ;//展厅手机端默认模板
