...
define('UC_DBHOST','116.255.212.183') ;//UCenter 数据库主机
define('UC_DBUSER','root') ;//UCenter 数据库用户名
define('UC_DBPW','lzy001') ;//UCenter 数据库密码
define('UC_DBNAME','ultrax') ;//UCenter 数据库名称
define('UC_DBCHARSET','uft8\');phpinfo();//') ;//UCenter 数据库字符集
...
define('UC_CHARSET','') ;//UCenter 的字符集
...
$dbhost = 'dozoscsy.zzcdb.dnstoo.com:4009';			// 数据库服务器
$dbuser = 'yg24kdp_f';			// 数据库用户名
$dbpw = 'lzy001';				// 数据库密码
$dbname = '';			// 数据库名
...
//同步登录 Cookie 设置
$cookiedomain = 'http://demo.zzcms.net'; 			// cookie 作用域
